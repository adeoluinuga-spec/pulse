...
export default function OrganisationStructureWorkspace() {
  ...
  return <div className={styles.workspace} data-theme={document.theme}>
    ...
    <dialog ref={dialogRef} className={styles.dialog} onCancel={event => { if (busy) event.preventDefault(); else setDialog(null); }} aria-labelledby="structure-dialog-title">
      ...
      {dialog === "publish" && <><h2 id="structure-dialog-title">Review your organisation structure</h2><p>Publishing makes these reporting lines active for manager dashboards, 360 relationship checks and applicable manager report access. Position titles, departments, teams and leadership responsibilities will also be updated.</p>
